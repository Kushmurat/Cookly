            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/salad_avocado.png',
                    height: 250,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildInfoIcon(Icons.timer, '20 мин'),
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Свежий и пикантный салат с кремовым авокадо и '
                        'сочным грейпфрутом. Отличное сочетание текстур'
                        'и вкусов, заправленное легким цитрусовым\n'
                        'соусом',
    ...
    final steps = [
      {
        ...
        'description': ' • Очистите грейпфрут и нарежьте дольками, удаляя мембраны.\n'
            '• Нарвите листья шпината.\n'
      ...
      {
        'title': 'Сборка салата',
        'description': '• Выложите листья салата на тарелку.\n'
            '• Добавьте грейпфрут, авокадо и красный лук.'
            '• Смешайте оливковое масло, сок лимон и мед для заправки.'
